...
public final class IconManager {
    ...
    public static int getDrawableId(Context context,String mimeType) {
	    ...
	    return R.drawable.fm_excel;
	} else if (mimeType.startsWith("application/msword")) {
	    return R.drawable.fm_doc;
	} else if (mimeType.startsWith("application/pdf")) {
	    return R.drawable.fm_pdf;
	} else if (mimeType.startsWith("application/mspowerpoint") || mimeType.startsWith("application/vnd.openxmlformats-officedocument.presentationml.presentation")) {
