...
import android.content.ActivityNotFoundException; /*ckt guoyi add for fix widget crash bug 2014-4-25*/
...
public class WidgetActionActivity extends Activity implements
    ...
    private void fireContactSelectActivity() {
        ...
        catch (ActivityNotFoundException e) /*ckt guoyi add for fix widget crash bug 2014-4-25*/
        {
            Toast.makeText(this, R.string.toast_activity_not_found,
        ...
        if (isValidUri(uri)) {
            ...
            mLeaveForActivity = true;
			  try{
        		...
        		finish();
        		Toast.makeText(WidgetActionActivity.this, getString(R.string.toast_activity_not_found), Toast.LENGTH_LONG).show();
        		}
