...
void AFMModules::Execute(int feature_id, RPCClient* msgSender)
{
	...
	case CKT_FUNCTION_EM_SENSOR_GET_PS_DATA:
		ModuleCktSensor::getPSData(msgSender);
		break;

	case CKT_FUNCTION_EM_SENSOR_GET_PS_Off_DATA:
		ModuleCktSensor::getPSOffData(msgSender);
		break;
		
	case CKT_FUNCTION_EM_SENSOR_DO_PS_CALIBRATION:
		ModuleCktSensor::doPSCalibration(msgSender);
		break;

	case CKT_FUNCTION_EM_SENSOR_CLEAR_PS_CALIBRATION:
		ModuleCktSensor::clearPSCalibration(msgSender);
		break;
