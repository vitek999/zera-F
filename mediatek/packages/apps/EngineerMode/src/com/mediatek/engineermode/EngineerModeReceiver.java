...
public class EngineerModeReceiver extends BroadcastReceiver {
    ...
    // process *#*#13646633#*#*
    private final Uri mEmUri = Uri.parse("android_secret_code://13646633");

    @Override
    public void onReceive(Context context, Intent intent) {
        Xlog.d(TAG,"EngineerModeReceiver():intent="+intent);
        Xlog.d(TAG,"EngineerModeReceiver():action="+intent.getAction());
        Xlog.d(TAG,"EngineerModeReceiver():data="+intent.getData());
