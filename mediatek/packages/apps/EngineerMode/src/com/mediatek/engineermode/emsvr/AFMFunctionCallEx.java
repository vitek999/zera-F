...
public class AFMFunctionCallEx {
	...
	public static final int CKT_FUNCTION_EM_SENSOR_BASE = 150000;
	public static final int CKT_FUNCTION_EM_SENSOR_GET_PS_DATA = CKT_FUNCTION_EM_SENSOR_BASE+1;
	public static final int CKT_FUNCTION_EM_SENSOR_GET_PS_Off_DATA = CKT_FUNCTION_EM_SENSOR_BASE+2;
	public static final int CKT_FUNCTION_EM_SENSOR_DO_PS_CALIBRATION = CKT_FUNCTION_EM_SENSOR_BASE+3;
	public static final int CKT_FUNCTION_EM_SENSOR_CLEAR_PS_CALIBRATION = CKT_FUNCTION_EM_SENSOR_BASE+4;
