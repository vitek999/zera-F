...
public static int cktGetPsensorData (int[] result) {
		String[] ret = runCmdInEmSvr(
                AFMFunctionCallEx.CKT_FUNCTION_EM_SENSOR_GET_PS_DATA, 0);
		
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
// 苏 勇 2013年09月23日 15:23:02				Xlog.d(TAG, "cktGetPsensorData return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
                Xlog.d(TAG, "cktGetPsensorData return NumberFormatException");
            }
        }
		Xlog.e(TAG, "cktGetPsensorData returnfalse");

        return RET_FAILED;
}

public static int cktGetPsensorOffData (int[] result) {
		String[] ret = runCmdInEmSvr(
                AFMFunctionCallEx.CKT_FUNCTION_EM_SENSOR_GET_PS_Off_DATA, 0);
		
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
// 苏 勇 2013年09月23日 15:23:06				Xlog.e(TAG, "cktGetPsensorOffData return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
                Xlog.e(TAG, "cktGetPsensorOffData return NumberFormatException");
            }
        }
		Xlog.e(TAG, "cktGetPsensorOffData return false");

        return RET_FAILED;
}
public static int doCktPsensorCalibration(int[] result) {
		String[] ret = runCmdInEmSvr(
                AFMFunctionCallEx.CKT_FUNCTION_EM_SENSOR_DO_PS_CALIBRATION, 0);
		
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
// 苏 勇 2013年09月23日 15:23:11				Xlog.e(TAG, "doCktPsensorCalibration return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
                Xlog.e(TAG, "doCktPsensorCalibration return NumberFormatException");
            }
        }
		Xlog.e(TAG, "doCktPsensorCalibration return false");

        return RET_FAILED;
}
public static int clearCktPsensorCalibration(int[] result) {
	String[] ret = runCmdInEmSvr(
                AFMFunctionCallEx.CKT_FUNCTION_EM_SENSOR_CLEAR_PS_CALIBRATION, 0);
		
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
				Xlog.e(TAG, "clearCktPsensorCalibration return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
                Xlog.e(TAG, "clearCktPsensorCalibration return NumberFormatException");
            }
        }
		Xlog.e(TAG, "clearCktPsensorCalibration return false");
