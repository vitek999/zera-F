...
import com.redbend.vdm.fumo.VdmFumoUpdateResult;
...
public class DmController {
     ...
     * 
     * @param VdmFumoUpdateResult
     *            .ResultCode inResultCode - result of update
     */
    public void triggerReportSession(VdmFumoUpdateResult.ResultCode inResultCode) {
        try {
            Log.i(TAG.CONTROLLER,
