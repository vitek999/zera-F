...
public class TestAGPSParamsProvider extends AndroidTestCase {
    ...
    private MtkAgpsProfile agpsProfile;
    ...
    protected void setUp() throws Exception {
        ...
        if (READ_FROM_DB) {
            ...
            mAgpsMgr = (MtkAgpsManager) mContext.getSystemService(Context.MTK_AGPS_SERVICE);
            agpsProfile = mAgpsMgr.getProfile();
        }
    }
    ...
    public void testReadConRef() {
        ...
        assertTrue(readResult == null || readResult.equals(agpsProfile.optionApn2));
    }
    ...
    public void testReadToConRef() {
        ...
        assertTrue(readResult == null || readResult.equals(agpsProfile.optionApn));
    }
    ...
    public void testReadport() {
        ...
        assertTrue(readResult == null
                || readResult.equals(agpsProfile.addrType));
