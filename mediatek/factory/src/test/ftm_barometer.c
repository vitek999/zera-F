...
int barometer_entry(struct ftm_param *param, void *priv)
{
    ...
    init_text(&dat->left_btn, uistr_key_fail, COLOR_YELLOW);
    init_text(&dat->center_btn, uistr_key_pass, COLOR_YELLOW);
    init_text(&dat->right_btn, uistr_key_back, COLOR_YELLOW);
