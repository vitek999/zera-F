...
$(foreach t,$(CKT_AUTO_ADD_GLOBAL_DEFINE_BY_NAME),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(CKT_AUTO_ADD_GLOBAL_DEFINE_BY_VALUE),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))),-D$(v))))
$(foreach t,$(CKT_AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(call .if-cfg-on,$(t),-D$(call uc,$(t))=\"$($(t))\")))
endef
...
MTK_PROJECT_CONFIGS := $(call wildcard2,$(foreach c,$(call reverse,$(addsuffix /ProjectConfig.mk,\
    ...
    $(call wildcard2,$(foreach c,$(call reverse,$(addsuffix /ProjectConfig_ckt.mk,\
    $(addprefix ../../config/,$(MTK_CONFIG_FOLDERS)))),$(call relative-path,$(c))))
