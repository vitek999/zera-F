...
char const*const RED_TRIGGER_BRIGHTNESS
        = "/sys/class/leds/red/trig_brightness";
#endif
...
#ifdef RESPIRATION_LAMP
char const*const GREEN_TRIGGER_BRIGHTNESS
        = "/sys/class/leds/green/trig_brightness";
#endif
...
#ifdef RESPIRATION_LAMP
char const*const BLUE_TRIGGER_BRIGHTNESS
        = "/sys/class/leds/blue/trig_brightness";
#endif
...
//        	write_int(RED_LED_FILE, level); // default full brightness
		...
		#ifdef RESPIRATION_LAMP
		write_int(RED_TRIGGER_BRIGHTNESS, level);
		#endif
...
//        	write_int(GREEN_LED_FILE, level); // default full brightness
		...
		#ifdef RESPIRATION_LAMP
		write_int(GREEN_TRIGGER_BRIGHTNESS, level);
		#endif
...
//        	write_int(BLUE_LED_FILE, level); // default full brightness
		...
		#ifdef RESPIRATION_LAMP
		write_int(BLUE_TRIGGER_BRIGHTNESS, level);
		#endif
