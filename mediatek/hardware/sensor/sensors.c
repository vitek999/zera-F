...
extern struct sensor_t pSensor[MAX_NUM_SENSOR];
...
// 苏 勇 2013年11月04日 17:36:28	ALOGD(" sSensorList addr =%x\r\n",sSensorList);
// 苏 勇 2013年11月04日 17:36:28	ALOGD(" ARRAY_SIZE(sSensorList) =%d\r\n",ARRAY_SIZE(sSensorList));
// 苏 勇 2013年11月04日 17:36:28    *list = sSensorList;
// 苏 勇 2013年11月04日 17:36:28    return ARRAY_SIZE(sSensorList);
	int num=GenpSensor();
	*list = pSensor;
	return num;
}
