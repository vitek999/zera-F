...
#define OV5645MIPI_IMAGE_SENSOR_720P_WIDTH          800//(1280)
#define OV5645MIPI_IMAGE_SENSOR_720P_HEIGHT         600//(720)
...
#define OV5645MIPI_PV_GRAB_START_X 				(2)
#define OV5645MIPI_PV_GRAB_START_Y  			(2)
#define OV5645MIPI_FULL_GRAB_START_X   			(2)
#define OV5645MIPI_FULL_GRAB_START_Y	  		(2)
