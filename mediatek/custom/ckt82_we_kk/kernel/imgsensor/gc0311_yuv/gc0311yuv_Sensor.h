...
#ifndef __GC0311_SENSOR_H
#define __GC0311_SENSOR_H
...
#define GC0311_WRITE_ID							0x66
#define GC0311_READ_ID								0x67

// GC0311 SENSOR Chip ID: 0xbb

typedef enum
{
	GC0311_RGB_Gamma_m1 = 0,
	GC0311_RGB_Gamma_m2,
	GC0311_RGB_Gamma_m3,
	GC0311_RGB_Gamma_m4,
	GC0311_RGB_Gamma_m5,
	GC0311_RGB_Gamma_m6,
	GC0311_RGB_Gamma_night
}GC0311_GAMMA_TAG;
...
UINT32 GC0311Control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 GC0311FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
UINT32 GC0311GetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
