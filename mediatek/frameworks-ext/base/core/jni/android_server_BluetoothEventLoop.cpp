...
#else
// 苏 勇 2012年11月08日 10:57:11        char value[MAX_VALUE_LEN];
// 苏 勇 2012年11月08日 10:57:11        int result = custom_get_string(MODULE_BLUETOOTH, HOST_NAME, value, BTMTK_ANDROID_DEFAULT_LOCAL_NAME);
        unlink(BTMTK_HOST_CACHE_PATH);
// 苏 勇 2012年11月08日 10:56:57        strncpy(nat->host_cache.name, value, BTBM_ADP_MAX_NAME_LEN);
        strncpy(nat->host_cache.name, BTMTK_ANDROID_DEFAULT_LOCAL_NAME, BTBM_ADP_MAX_NAME_LEN);
#endif
